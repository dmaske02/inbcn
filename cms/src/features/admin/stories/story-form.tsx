...
const commandLabels: Record<StoryCommand, string> = { save: "Save", submit: "Submit for review", request_changes: "Request changes", approve: "Approve", reject: "Reject", send_back: "Send back to draft", publish: "Publish", schedule: "Schedule", cancel_schedule: "Cancel schedule", unpublish: "Unpublish", archive: "Archive", delete: "Delete" };
