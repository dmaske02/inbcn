  ...
  return (
    <div className="space-y-6">
      ...
      <header>
        ...
        <p className="mt-2 max-w-2xl text-sm text-muted-foreground">Live trust and an active membership are required. General reporter trust never approves a specific event: editorial approval sets the broadcast window, and the session is recorded.</p>
      </header>
